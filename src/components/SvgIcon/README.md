...
/**
 * 1.
 * vite-svg-loader 可以直接引入 svg 当成组件
 */
...
/**
 * 2.
 * 使用 icon-font(Symbol)，内置 test-left/right/up/down 4个图标
 * 使用 iconfont 需要在 main.ts 引入 iconfont.js 文件
 * 或者 本地 assets/svg 图标。
 */
...
/**
 * 3.
 * iconfy ，可以从https://icones.js.org/collection/ep 找到需要的图标
